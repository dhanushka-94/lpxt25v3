...
@section('title', 'Categories - LAPTOP EXPERT')
@section('description', 'Browse our computer hardware categories including gaming PCs, laptops, monitors, and components at LAPTOP EXPERT.')
...
<section class="py-12 bg-gray-900/50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('products.index') }}" class="btn-primary px-6 py-3">Browse All Products</a>
            <a href="{{ route('contact-us.index') }}" class="btn-outline px-6 py-3">Contact Support</a>
        </div>
    </div>
</section>
@endsection
