        ...
        <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-white">{{ number_format($stats['today_orders']) }}</p>
        ...
        <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-white">LKR {{ number_format($stats['today_revenue'], 2) }}</p>
        ...
        <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">{{ number_format($stats['processing_orders']) }}</p>
        ...
        <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">{{ number_format($stats['shipped_orders']) }}</p>
            ...
            <div class="space-y-3">
                <a href="{{ route('admin.orders.index', ['status' => 'pending']) }}" 
                   class="flex items-center justify-between p-2 bg-yellow-500/10 border border-yellow-500/20 rounded-lg hover:bg-yellow-500/20 transition-colors">
                    ...
                    <span class="text-yellow-400 font-medium">{{ $stats['pending_orders'] }}</span>
                </a>
    ...
    <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="text-center">
                <div class="text-2xl font-bold text-blue-400">{{ number_format($stats['today_orders']) }}</div>
            ...
            <div class="text-center">
                <div class="text-2xl font-bold text-yellow-400">{{ number_format($stats['pending_orders']) }}</div>
