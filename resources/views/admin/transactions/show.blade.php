    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
                ...
                <div class="bg-[#0f0f0f] rounded-lg p-4">
                    <pre class="text-sm text-gray-300 overflow-x-auto"><code>{{ json_encode($transaction->gateway_response, JSON_PRETTY_PRINT) }}</code></pre>
                </div>
            </div>
            @endif
                    ...
                    <div class="flex items-center space-x-4 p-4 bg-[#0f0f0f] rounded-lg">
                        @if($item->product)
                            ...
                            <div class="flex-1">
                                ...
                                @else
                                    <p class="text-[#f59e0b] font-medium">LKR {{ number_format($item->unit_price, 2) }} each</p>
                                @endif
                            </div>
                            <div class="text-right">
                                @if($hasDiscount)
                                    <div class="space-y-1">
                                        <p class="text-white font-medium">LKR {{ number_format($item->total_price, 2) }}</p>
                        ...
                        @else
                            ...
                            <div class="flex-1">
                                <h4 class="text-gray-400 font-medium">{{ $item->product_name ?? 'Product Not Found' }}</h4>
                                @if($item->product_code)
                                    <p class="text-gray-500 text-xs">Code: {{ $item->product_code }}</p>
                                @endif
                                <p class="text-gray-500 text-sm">Quantity: {{ $item->quantity }}</p>
                                <p class="text-gray-400 font-medium">LKR {{ number_format($item->unit_price, 2) }} each</p>
                            </div>
                            <div class="text-right">
                                <p class="text-gray-400 font-medium">LKR {{ number_format($item->total_price, 2) }}</p>
                            </div>
                        @endif
                    </div>
                    @endforeach
                                ...
                                <div class="space-y-2 text-sm">
                                    ...
                                    @if($transaction->gateway_reference)
                                        <div class="flex justify-between">
                                            ...
                                            <span class="text-blue-400 font-mono text-xs">{{ $transaction->gateway_reference }}</span>
                                        </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-gray-700/30 rounded-lg p-4">
                                ...
                                <div class="text-sm text-gray-300">
                                    ...
                                    <p class="text-blue-400">📞 {{ $order->customer_phone }}</p>
        ...
        <div class="space-y-8">
            ...
            <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-white font-medium">LKR {{ number_format($transaction->amount, 2) }}</span>
                    </div>

                    @if($transaction->transaction_fee > 0)
                    <div class="flex justify-between items-center">
                        <span class="text-gray-400">Transaction Fee</span>
                        <span class="text-white font-medium">LKR {{ number_format($transaction->transaction_fee, 2) }}</span>
                    </div>
                    
                    <div class="border-t border-gray-700 pt-4">
                        <div class="flex justify-between items-center">
                            <span class="text-white font-semibold">Total Amount</span>
                            <span class="text-[#f59e0b] font-bold text-lg">LKR {{ number_format($transaction->total_amount, 2) }}</span>
                        </div>
                    </div>
                    @endif
                </div>
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-400 text-xs">{{ $transaction->created_at->format('M d, Y H:i:s') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-400 text-xs">{{ $transaction->initiated_at->format('M d, Y H:i:s') }}</p>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-400 text-xs">{{ $transaction->completed_at->format('M d, Y H:i:s') }}</p>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-400 text-xs">{{ $transaction->failed_at->format('M d, Y H:i:s') }}</p>
                        </div>
                    </div>
                    @endif
                </div>
            ...
            <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
                ...
                <div class="bg-[#0f0f0f] rounded-lg p-4">
                    <pre class="text-sm text-gray-300 overflow-x-auto"><code>{{ json_encode($transaction->metadata, JSON_PRETTY_PRINT) }}</code></pre>
                </div>
            </div>
            @endif
        </div>
