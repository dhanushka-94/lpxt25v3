...
@section('title', 'Contact Us - LAPTOP EXPERT | Laptop Sales, Repair & Service Support in Sri Lanka')
@section('description', 'Contact LAPTOP EXPERT for all your laptop needs. Brand new and used laptops, professional laptop repair services, and all laptop accessories. Expert technicians and quality service in Sri Lanka.')
@section('keywords', 'contact Laptop Expert, laptop repair Sri Lanka, laptop service, laptop sales, laptop technical support, laptop accessories, brand new laptops, used laptops, Colombo, Sri Lanka')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <h1 class="text-4xl md:text-6xl font-bold text-white mb-6">
                Contact <span class="text-blue-500">LAPTOP EXPERT</span>
            </h1>
            <p class="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Ready to help you with all your computer needs. From sales to repairs, our expert team is here to provide the best service in Sri Lanka.
            </p>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-[#1a1a1c] border border-gray-800 rounded-xl p-8 text-center hover:border-blue-500/30 transition-all duration-300">
                ...
                <h3 class="text-3xl font-bold text-blue-500 mb-2">3000+</h3>
            ...
            <div class="bg-[#1a1a1c] border border-gray-800 rounded-xl p-8 text-center hover:border-blue-500/30 transition-all duration-300">
                ...
                <h3 class="text-3xl font-bold text-blue-500 mb-2">10,000+</h3>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <form class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="first_name" name="first_name" placeholder="John" 
                                   class="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300">
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <select id="service_type" name="service_type" 
                                class="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300">
                    ...
                    <div>
                        ...
                        <textarea id="message" name="message" rows="5" placeholder="Tell us how we can help you..." 
                                  class="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 resize-vertical"></textarea>
                    </div>

                    <!-- Submit Button -->
                    <button type="submit" 
                            class="w-full bg-blue-500 text-black font-bold py-4 px-6 rounded-lg hover:bg-blue-600 transition-colors duration-300 transform hover:scale-[1.02]">
            ...
            <div class="space-y-8">
                <!-- Visit Our Store -->
                <div class="bg-[#1a1a1c] border border-gray-800 rounded-xl p-8">
                    <h2 class="text-3xl font-bold text-white mb-6">Visit Our Store</h2>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-white mb-2">LAPTOP EXPERT</h3>
                                <p class="text-gray-300">296/3/C, Delpe Junction, Ragama</p>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <p class="text-white font-semibold mb-1">076 444 222 1</p>
                                <p class="text-gray-400 text-sm mb-2">011 296 066 0</p>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <p class="text-white font-semibold mb-1">info@laptopexpert.lk</p>
                ...
                <div class="bg-[#1a1a1c] border border-gray-800 rounded-xl p-8">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center p-4 bg-gray-800/50 rounded-lg">
                            ...
                            <span class="text-blue-500 font-bold">9:00 AM - 6:30 PM</span>
                        </div>
                        <div class="flex justify-between items-center p-4 bg-gray-800/50 rounded-lg">
                            <span class="text-gray-300 font-medium">Saturday to Sunday:</span>
                            <span class="text-blue-500 font-bold">9:00 AM - 5:30 PM</span>
                        </div>
                        <div class="flex justify-between items-center p-4 bg-red-500/10 border border-red-500/30 rounded-lg">
                            <span class="text-red-400 font-medium">Closed on Poya Days</span>
...
<section class="py-16 bg-black">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">Find Us on the Map</h2>
            <p class="text-lg text-gray-400">Conveniently located in Ragama for easy access to all our services.</p>
        </div>
        
        <div class="bg-[#1a1a1c] border border-gray-800 rounded-xl overflow-hidden">
            <!-- Google Maps Embed -->
            <div class="relative">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.899836421997!2d79.9346673!3d7.021059!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae2f9373646927b%3A0x91915505270cdb9b!2sMSK%20COMPUTERS!5e0!3m2!1sen!2slk!4v1758994425464!5m2!1sen!2slk" 
                        width="100%" 
                        height="450" 
                        style="border:0;" 
                        allowfullscreen="" 
            ...
            <!-- Map Info Bar -->
            <div class="p-6 bg-[#0f0f0f] border-t border-gray-800">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-400 text-sm">296/3/C, Delpe Junction, Ragama</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-400 text-sm">0112 95 9005 / 0777 50 69 39</p>
                        </div>
                    </div>
