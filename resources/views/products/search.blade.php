...
@section('title', 'Search Results for "' . $searchTerm . '" - Laptops & Accessories | LAPTOP EXPERT')
@section('description', 'Search results for ' . $searchTerm . ' - Find brand new and used laptops, laptop accessories, and repair services at Laptop Expert in Sri Lanka.')
