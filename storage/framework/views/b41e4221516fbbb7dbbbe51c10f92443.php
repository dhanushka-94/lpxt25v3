<?php $__env->startSection('title', 'Search Results for "' . $searchTerm . '" - MSK Computers'); ?>
<?php $__env->startSection('description', 'Search results for computer hardware and technology products at MSK Computers.'); ?>
    ...
    <section class="relative bg-gradient-to-r from-[#0f0f0f] to-[#1a1a1c] border-b border-gray-800/30 py-8">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="flex items-center justify-between">
                ...
                Results for "<span class="text-primary-400"><?php echo e($searchTerm); ?></span>"
            </p>
                    </div>
                </div>
        ...
        <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="lg:w-64 flex-shrink-0">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-2">
                            <a href="<?php echo e(route('products.search', ['q' => $searchTerm])); ?>" 
                                   class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(!request('category') ? 'bg-primary-500 text-black' : 'text-gray-300 hover:bg-primary-500/10 hover:text-primary-400'); ?>">
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('products.search', ['q' => $searchTerm, 'category' => $category->slug ?: $category->id])); ?>" 
                                       class="flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all <?php echo e(request('category') == ($category->slug ?: $category->id) ? 'bg-primary-500 text-black' : 'text-gray-300 hover:bg-primary-500/10 hover:text-primary-400'); ?>">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <form method="GET" action="<?php echo e(route('products.search')); ?>" id="sortForm">
                            <input type="hidden" name="q" value="<?php echo e($searchTerm); ?>">
                            <?php if(request('category')): ?>
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    <div>
                            ...
                            <?php if(request('category')): ?>
                                        in <span class="text-primary-400"><?php echo e($categories->where('slug', request('category'))->first()->name ?? 'Category'); ?></span>
                            <?php endif; ?>
                        </p>
                    </div>
                </div>
                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('products.show', ['category' => $product->category ? ($product->category->slug ?: $product->category->id) : $product->category_id, 'product' => $product->slug ?: $product->id])); ?>" 
                                   class="group bg-[#1c1c1e] rounded-xl border border-gray-800/30 overflow-hidden hover:border-primary-500/30 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-primary-500/10">
                                    ...
                                    <div class="relative overflow-hidden bg-[#1a1a1c] aspect-square">
                                        ...
                                        <div class="absolute top-3 left-3">
                                            <div class="bg-primary-500/90 text-black text-xs font-medium px-2 py-1 rounded-lg backdrop-blur-sm">
                                                <?php echo e($product->category ? $product->category->name : 'Uncategorized'); ?>
                                    ...
                                    <div class="p-4">
                                        <h3 class="text-sm font-semibold text-white mb-3 line-clamp-2 group-hover:text-primary-400 transition-colors">
                                            <?php echo preg_replace('/(' . preg_quote($searchTerm, '/') . ')/i', '<span class="bg-primary-500 text-black px-1 rounded">$1</span>', $product->name); ?>

                                    </h3>

                                        <!-- Pricing -->
                                        <div class="mb-4">
                                            <?php if($product->is_on_sale && $product->promo_price > 0): ?>
                                        ...
                                        <div class="mt-auto">
                                            <?php if($product->can_add_to_cart): ?>
                                                <button onclick="event.preventDefault(); event.stopPropagation(); addToCartFromSearch(<?php echo e($product->id); ?>, '<?php echo e(addslashes($product->name)); ?>')" 
                ...
                <?php else: ?>
                    ...
                    <div class="text-center py-16">
                        ...
                        <h3 class="text-xl font-semibold text-white mb-2">No Results Found</h3>
                            <p class="text-gray-400 mb-6">Sorry, we couldn't find any products matching "<span class="text-primary-400"><?php echo e($searchTerm); ?></span>" that are currently in stock.</p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\MSK\MSKMSV3\resources\views/products/search.blade.php ENDPATH**/ ?>