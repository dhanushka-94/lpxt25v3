...
<?php $__env->startSection('title', 'Track Your Order - MSK COMPUTERS'); ?>
...
<div class="min-h-screen bg-[#0a0a0a] py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-[#1c1c1e] rounded-xl border border-gray-800/30 p-8 mb-8">
            ...
            <form method="POST" action="<?php echo e(route('orders.track')); ?>">
                <?php echo csrf_field(); ?>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" 
                               ...
                               class="w-full bg-gray-800 border border-gray-600 rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:border-primary-500 <?php $__errorArgs = ['order_number'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="email" 
                               ...
                               class="w-full bg-gray-800 border border-gray-600 rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:border-primary-500 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="bg-[#1c1c1e] rounded-xl border border-gray-800/30 p-8 mb-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('user.orders')); ?>" class="bg-primary-500 hover:bg-primary-600 text-white px-4 py-2 rounded-lg transition-colors">
                    View All Orders
                </a>
            </div>
                ...
                <div class="space-y-4">
                    <?php $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-gray-800/30 rounded-lg p-4 flex items-center justify-between">
                            <div class="flex items-center">
                                <div class="mr-4">
                                    <div class="text-white font-medium"><?php echo e($order->order_number); ?></div>
                                    <div class="text-gray-400 text-sm"><?php echo e($order->created_at->format('M d, Y')); ?></div>
                                </div>
                                <div class="mr-4">
                                ...
                                <div>
                                    <div class="text-white font-medium">Rs. <?php echo e(number_format($order->total_amount, 2)); ?></div>
                                    <div class="text-gray-400 text-sm"><?php echo e($order->orderItems->count()); ?> item(s)</div>
                                </div>
                            </div>
            ...
            <?php else: ?>
                <div class="text-center py-8">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="text-primary-400 hover:text-primary-300 transition-colors">Start Shopping</a>
                </div>
            <?php endif; ?>
        </div>
        <?php endif; ?>
        ...
        <div class="bg-[#1c1c1e] rounded-xl border border-gray-800/30 p-8 mb-8">
            <div class="flex items-center mb-6">
                <div class="bg-white/10 p-3 rounded-lg mr-4 flex items-center justify-center">
                    <img src="<?php echo e(asset('images/promtexpress.png')); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\MSK\MSKMSV3\resources\views/orders/track.blade.php ENDPATH**/ ?>