...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title><?php echo $__env->yieldContent('title', 'LAPTOP EXPERT - Brand New & Used Laptops, Repair & Service, Accessories in Sri Lanka'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'Laptop Expert - Your trusted destination for brand new and used laptops, laptop repair services, and all laptop accessories in Sri Lanka. Expert service, quality products, and affordable prices.'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('keywords', 'laptops Sri Lanka, brand new laptops, used laptops, laptop repair, laptop service, laptop accessories, laptop parts, laptop screen repair, laptop battery, laptop charger, Laptop Expert, Sri Lanka, Colombo'); ?>">
    <meta name="author" content="Laptop Expert">
    <meta name="robots" content="index, follow">
    
    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="<?php echo $__env->yieldContent('og_title', 'LAPTOP EXPERT - Brand New & Used Laptops in Sri Lanka'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('og_description', 'Laptop Expert - Brand new and used laptops, professional laptop repair & service, and all laptop accessories in Sri Lanka. Expert technicians, quality products.'); ?>">
    <meta property="og:image" content="<?php echo $__env->yieldContent('og_image', asset('laptop-expert.webp')); ?>">
    ...
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('og_title', 'LAPTOP EXPERT - Brand New & Used Laptops in Sri Lanka'); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('og_description', 'Laptop Expert - Brand new and used laptops, professional laptop repair & service, and all laptop accessories in Sri Lanka. Expert technicians, quality products.'); ?>">
    <meta name="twitter:image" content="<?php echo $__env->yieldContent('og_image', asset('laptop-expert.webp')); ?>">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between h-24 sm:h-28 md:h-32 lg:h-36 border-b border-blue-500/20 gap-2 sm:gap-3 md:gap-4">
                ...
                <div class="flex items-center flex-shrink-0 min-w-0">
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-2 sm:space-x-3 md:space-x-4 group">
                        <div class="relative flex items-center flex-shrink-0">
                            ...
                            <img src="<?php echo e(asset('laptop-expert.webp')); ?>" 
                ...
                <div class="flex items-center space-x-1.5 sm:space-x-2 md:space-x-3 flex-shrink-0">
                        ...
                        <div class="relative group">
                            <div class="flex items-center space-x-1.5 sm:space-x-2 text-gray-300 hover:text-blue-400 transition-all duration-200 cursor-pointer py-1.5 sm:py-2 px-2 sm:px-3 rounded-xl hover:bg-blue-500/10 border border-transparent hover:border-blue-500/30 min-w-[44px] min-h-[44px] sm:min-w-0 sm:min-h-0 justify-center sm:justify-start">
                                ...
                                <div class="hidden lg:block">
                                    <p class="text-sm font-semibold truncate max-w-[120px]"><?php echo e(Auth::user()->name); ?></p>
                            ...
                            <div class="absolute top-full right-0 mt-2 w-64 bg-[#0a0a0a]/95 border border-blue-500/30 rounded-xl shadow-2xl shadow-blue-500/20 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-[9999] backdrop-blur-md">
                                <div class="py-2">
                                    <a href="<?php echo e(route('user.dashboard')); ?>" class="flex items-center px-4 py-2 text-gray-300 hover:bg-blue-500/10 hover:text-blue-400 transition-all duration-200 border-l-2 border-transparent hover:border-blue-500">
                                        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/>
                                        </svg>
                                        Dashboard
                                    </a>
                                    <a href="<?php echo e(route('profile.show')); ?>" class="flex items-center px-4 py-2 text-gray-300 hover:bg-blue-500/10 hover:text-blue-400 transition-all duration-200 border-l-2 border-transparent hover:border-blue-500">
                                        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                        </svg>
                                        Profile Settings
                                    </a>
                                    <a href="<?php echo e(route('user.orders')); ?>" class="flex items-center px-4 py-2 text-gray-300 hover:bg-blue-500/10 hover:text-blue-400 transition-all duration-200 border-l-2 border-transparent hover:border-blue-500">
                                        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                                        </svg>
                                        My Orders
                                    </a>
                                    <a href="<?php echo e(route('orders.track')); ?>" class="flex items-center px-4 py-2 text-gray-300 hover:bg-blue-500/10 hover:text-blue-400 transition-all duration-200 border-l-2 border-transparent hover:border-blue-500">
                                        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/>
                                        </svg>
                                        Track Order
                                    </a>
                                    <a href="<?php echo e(route('user.settings')); ?>" class="flex items-center px-4 py-2 text-gray-300 hover:bg-blue-500/10 hover:text-blue-400 transition-all duration-200 border-l-2 border-transparent hover:border-blue-500">
                                        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Mobile Cart Icon -->
                    <a href="<?php echo e(route('cart.index')); ?>" class="relative cart-container-mobile group sm:hidden flex items-center text-gray-300 hover:text-blue-400 transition-all duration-200 py-2 px-2.5 rounded-xl hover:bg-blue-500/10 border border-transparent hover:border-blue-500/30 min-w-[44px] min-h-[44px] justify-center">
                        <div class="relative">
            ...
            <div class="hidden md:flex items-center justify-center space-x-2 lg:space-x-4 h-16 bg-gradient-to-r from-blue-500/5 via-blue-500/10 to-blue-500/5 border-t border-blue-500/20">
                <a href="<?php echo e(route('home')); ?>" class="text-gray-300 hover:text-blue-400 transition-all duration-200 text-sm font-semibold whitespace-nowrap px-4 py-2.5 rounded-lg hover:bg-blue-500/10 <?php echo e(request()->routeIs('home') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> group">
                    <span class="flex items-center">
                        <svg class="w-4 h-4 mr-2 text-blue-500/50 group-hover:text-blue-400 <?php echo e(request()->routeIs('home') ? 'text-blue-400' : ''); ?> transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Categories Dropdown -->
                <div class="relative group">
                    <button class="text-gray-300 hover:text-blue-400 transition-all duration-200 text-sm font-semibold flex items-center whitespace-nowrap px-4 py-2.5 rounded-lg hover:bg-blue-500/10 <?php echo e(request()->routeIs('categories.*') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?>" id="categories-dropdown-trigger">
                        <svg class="w-4 h-4 mr-2 text-blue-500/50 group-hover:text-blue-400 <?php echo e(request()->routeIs('categories.*') ? 'text-blue-400' : ''); ?> transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/>
                        </svg>
                        Categories
                ...
                <a href="<?php echo e(route('promotions.index')); ?>" class="text-gray-300 hover:text-blue-400 transition-all duration-200 text-sm font-semibold whitespace-nowrap px-4 py-2.5 rounded-lg hover:bg-blue-500/10 <?php echo e(request()->routeIs('promotions.*') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> group flex items-center">
                    <svg class="w-4 h-4 mr-2 text-blue-500/50 group-hover:text-blue-400 <?php echo e(request()->routeIs('promotions.*') ? 'text-blue-400' : ''); ?> transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                    </svg>
                    Promotions
                </a>
                <a href="<?php echo e(route('orders.track')); ?>" class="text-gray-300 hover:text-blue-400 transition-all duration-200 text-sm font-semibold whitespace-nowrap px-4 py-2.5 rounded-lg hover:bg-blue-500/10 <?php echo e(request()->routeIs('orders.track') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> group flex items-center">
                    <svg class="w-4 h-4 mr-2 text-blue-500/50 group-hover:text-blue-400 <?php echo e(request()->routeIs('orders.track') ? 'text-blue-400' : ''); ?> transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/>
                    </svg>
                    Track Order
                </a>
                <a href="<?php echo e(route('services.index')); ?>" class="text-gray-300 hover:text-blue-400 transition-all duration-200 text-sm font-semibold whitespace-nowrap px-4 py-2.5 rounded-lg hover:bg-blue-500/10 <?php echo e(request()->routeIs('services.*') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> group flex items-center">
                    <svg class="w-4 h-4 mr-2 text-blue-500/50 group-hover:text-blue-400 <?php echo e(request()->routeIs('services.*') ? 'text-blue-400' : ''); ?> transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                    </svg>
                    Service Center
                </a>
                <a href="<?php echo e(route('bank-details.index')); ?>" class="text-gray-300 hover:text-blue-400 transition-all duration-200 text-sm font-semibold whitespace-nowrap px-4 py-2.5 rounded-lg hover:bg-blue-500/10 <?php echo e(request()->routeIs('bank-details.*') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> group flex items-center">
                    <svg class="w-4 h-4 mr-2 text-blue-500/50 group-hover:text-blue-400 <?php echo e(request()->routeIs('bank-details.*') ? 'text-blue-400' : ''); ?> transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
                    </svg>
                    Bank Details
                </a>
                <a href="<?php echo e(route('about-us.index')); ?>" class="text-gray-300 hover:text-blue-400 transition-all duration-200 text-sm font-semibold whitespace-nowrap px-4 py-2.5 rounded-lg hover:bg-blue-500/10 <?php echo e(request()->routeIs('about-us.*') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> group flex items-center">
                    <svg class="w-4 h-4 mr-2 text-blue-500/50 group-hover:text-blue-400 <?php echo e(request()->routeIs('about-us.*') ? 'text-blue-400' : ''); ?> transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    About Us
                </a>
                <a href="<?php echo e(route('contact-us.index')); ?>" class="text-gray-300 hover:text-blue-400 transition-all duration-200 text-sm font-semibold whitespace-nowrap px-4 py-2.5 rounded-lg hover:bg-blue-500/10 <?php echo e(request()->routeIs('contact-us.*') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> group flex items-center">
                    <svg class="w-4 h-4 mr-2 text-blue-500/50 group-hover:text-blue-400 <?php echo e(request()->routeIs('contact-us.*') ? 'text-blue-400' : ''); ?> transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                    </svg>
                    Contact Us
                </a>
                <a href="<?php echo e(route('e-services.index')); ?>" class="text-gray-300 hover:text-blue-400 transition-all duration-200 text-sm font-semibold whitespace-nowrap px-4 py-2.5 rounded-lg hover:bg-blue-500/10 <?php echo e(request()->routeIs('e-services.*') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> group flex items-center">
                    <svg class="w-4 h-4 mr-2 text-blue-500/50 group-hover:text-blue-400 <?php echo e(request()->routeIs('e-services.*') ? 'text-blue-400' : ''); ?> transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="md:hidden hidden mobile-menu" id="mobile-menu">
            <div class="px-4 pt-4 pb-3 space-y-4 bg-black border-t border-gray-800 max-h-[80vh] overflow-y-auto">
                ...
                <div class="space-y-3">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center py-3 text-gray-300 hover:text-blue-400 transition-colors <?php echo e(request()->routeIs('home') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> rounded-lg px-3">
                    ...
                    <a href="<?php echo e(route('promotions.index')); ?>" class="flex items-center py-3 text-gray-300 hover:text-blue-400 transition-all duration-200 <?php echo e(request()->routeIs('promotions.*') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> rounded-lg px-3">
                    ...
                    <a href="<?php echo e(route('orders.track')); ?>" class="flex items-center py-3 text-gray-300 hover:text-blue-400 transition-all duration-200 <?php echo e(request()->routeIs('orders.track') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> rounded-lg px-3">
                        <svg class="w-5 h-5 mr-3 text-blue-500/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/>
                        </svg>
                        Track Order
                ...
                <div class="space-y-3">
                    ...
                    <!-- All Categories Link -->
                    <a href="<?php echo e(route('categories.index')); ?>" class="flex items-center py-3 text-blue-400 hover:bg-blue-500/10 transition-colors rounded-lg px-3 border border-blue-500/30 bg-blue-500/5">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-3">
                    ...
                    <a href="<?php echo e(route('services.index')); ?>" class="flex items-center py-3 text-gray-300 hover:text-blue-400 transition-colors <?php echo e(request()->routeIs('services.*') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> rounded-lg px-3">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                        </svg>
                    ...
                    <a href="<?php echo e(route('bank-details.index')); ?>" class="flex items-center py-3 text-gray-300 hover:text-blue-400 transition-colors <?php echo e(request()->routeIs('bank-details.*') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> rounded-lg px-3">
                        <svg class="w-5 h-5 mr-3 text-blue-500/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
                        </svg>
                        Bank Details
                    ...
                    <a href="<?php echo e(route('about-us.index')); ?>" class="flex items-center py-3 text-gray-300 hover:text-blue-400 transition-colors <?php echo e(request()->routeIs('about-us.*') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> rounded-lg px-3">
                        <svg class="w-5 h-5 mr-3 text-blue-500/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        About Us
                    ...
                    <a href="<?php echo e(route('contact-us.index')); ?>" class="flex items-center py-3 text-gray-300 hover:text-blue-400 transition-colors <?php echo e(request()->routeIs('contact-us.*') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> rounded-lg px-3">
                        <svg class="w-5 h-5 mr-3 text-blue-500/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                        </svg>
                        Contact Us
                    ...
                    <a href="<?php echo e(route('e-services.index')); ?>" class="flex items-center py-3 text-gray-300 hover:text-blue-400 transition-colors <?php echo e(request()->routeIs('e-services.*') ? 'text-blue-400 bg-blue-500/15 border-l-2 border-blue-500' : ''); ?> rounded-lg px-3">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z"/>
                        </svg>
                        E-Services
                ...
                <div class="border-t border-gray-800 pt-3 mt-3">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <div class="space-y-2">
                            ...
                            <a href="<?php echo e(route('user.dashboard')); ?>" class="flex items-center py-2 text-gray-300 hover:text-blue-500 transition-colors">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/>
                                </svg>
                                Dashboard
                            </a>
                            <a href="<?php echo e(route('user.orders')); ?>" class="flex items-center py-2 text-gray-300 hover:text-blue-500 transition-colors">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/>
                                </svg>
                                My Orders
                            </a>
                            <a href="<?php echo e(route('profile.show')); ?>" class="flex items-center py-2 text-gray-300 hover:text-blue-500 transition-colors">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                </svg>
                                Profile Settings
                            </a>
                            <a href="<?php echo e(route('orders.track')); ?>" class="flex items-center py-2 text-gray-300 hover:text-blue-500 transition-colors">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/>
                                </svg>
                                Track Order
                            </a>
                            <a href="<?php echo e(route('user.settings')); ?>" class="flex items-center py-2 text-gray-300 hover:text-blue-500 transition-colors">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                </svg>
                    ...
                    <?php else: ?>
                        <!-- Guest User Menu -->
                        <div class="space-y-2">
                            <a href="<?php echo e(route('login')); ?>" class="flex items-center py-2 text-gray-300 hover:text-blue-500 transition-colors">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"/>
                                </svg>
                                Login
                            </a>
                            <a href="<?php echo e(route('register')); ?>" class="flex items-center py-2 text-gray-300 hover:text-blue-500 transition-colors">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('cart.index')); ?>" class="flex items-center justify-between py-2.5 px-3 text-gray-300 hover:text-blue-400 mobile-cart-container rounded-lg hover:bg-blue-500/10 border border-transparent hover:border-blue-500/30 transition-all">
                        <div class="flex items-center">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10 xl:gap-12 mb-8 sm:mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2 sm:space-y-3">
                        <li>
                            <a href="<?php echo e(route('home')); ?>" class="text-gray-400 hover:text-blue-400 transition-colors text-sm flex items-center group">
                        ...
                        <li>
                            <a href="<?php echo e(route('categories.index')); ?>" class="text-gray-400 hover:text-blue-400 transition-colors text-sm flex items-center group">
                                <svg class="w-4 h-4 mr-2 text-blue-500/50 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                </svg>
                                All Categories
                        ...
                        <li>
                            <a href="<?php echo e(route('promotions.index')); ?>" class="text-gray-400 hover:text-blue-400 transition-colors text-sm flex items-center group">
                                <svg class="w-4 h-4 mr-2 text-blue-500/50 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                </svg>
                                Promotions
                        ...
                        <li>
                            <a href="<?php echo e(route('orders.track')); ?>" class="text-gray-400 hover:text-blue-400 transition-colors text-sm flex items-center group">
                                <svg class="w-4 h-4 mr-2 text-blue-500/50 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                </svg>
                                Track Order
                        ...
                        <li>
                            <a href="<?php echo e(route('about-us.index')); ?>" class="text-gray-400 hover:text-blue-400 transition-colors text-sm flex items-center group">
                                <svg class="w-4 h-4 mr-2 text-blue-500/50 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                </svg>
                                About Us
                        ...
                        <li>
                            <a href="<?php echo e(route('contact-us.index')); ?>" class="text-gray-400 hover:text-blue-400 transition-colors text-sm flex items-center group">
                                <svg class="w-4 h-4 mr-2 text-blue-500/50 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                </svg>
                                Contact Us
                ...
                <div class="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
                    ...
                    <div class="text-center lg:text-left">
                        <p class="text-gray-400 text-sm">
                            © <?php echo e(date('Y')); ?> <span class="text-blue-400 font-semibold">LAPTOP EXPERT</span>. All rights reserved.
                        </p>
                    </div>
                        
                    <!-- Legal Links -->
                    <div class="flex flex-wrap justify-center gap-6">
                        <a href="<?php echo e(route('privacy-policy')); ?>" class="text-gray-400 hover:text-blue-400 text-sm transition-colors flex items-center group">
                        ...
                        <a href="<?php echo e(route('terms-of-service')); ?>" class="text-gray-400 hover:text-blue-400 text-sm transition-colors flex items-center group">
                            <svg class="w-3 h-3 mr-1 text-blue-500/50 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                    </svg>
                            Terms of Service
                        </a>
                        <a href="<?php echo e(route('warranty')); ?>" class="text-gray-400 hover:text-blue-400 text-sm transition-colors flex items-center group">
                            <svg class="w-3 h-3 mr-1 text-blue-500/50 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                    </svg>
                            Warranty
...
<?php /**PATH C:\Users\Dhanushka\Desktop\LaptopExpert Pvt Ltd\LPXTMSV3\resources\views/layouts/app.blade.php ENDPATH**/ ?>