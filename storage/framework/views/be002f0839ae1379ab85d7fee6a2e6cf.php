...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
        <form method="GET" action="<?php echo e(route('admin.analytics')); ?>">
            <div class="space-y-4">
                <!-- Filter Row -->
                <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                    ...
                    <div class="flex items-end space-x-2">
                        ...
                        <?php if(request()->hasAny(['date_from', 'date_to', 'period'])): ?>
                            <a href="<?php echo e(route('admin.analytics')); ?>" class="px-4 py-2 border border-gray-700 text-gray-300 rounded-lg hover:bg-gray-800 transition-colors text-sm flex items-center">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex flex-wrap gap-2 pt-2 border-t border-gray-700">
                        ...
                        <?php if(request('date_from') || request('date_to')): ?>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm bg-blue-900/50 text-blue-200 border border-blue-700">
                                ...
                                <?php endif; ?>
                                <a href="<?php echo e(route('admin.analytics', request()->except(['date_from', 'date_to']))); ?>" class="ml-2 text-blue-300 hover:text-blue-100">×</a>
                            </span>
                        <?php elseif(request('period')): ?>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm bg-green-900/50 text-green-200 border border-green-700">
                                ...
                                Last <?php echo e(request('period')); ?> Days
                                <a href="<?php echo e(route('admin.analytics', request()->except('period'))); ?>" class="ml-2 text-green-300 hover:text-green-100">×</a>
                            </span>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
