...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-4">
        <div class="flex flex-wrap items-center gap-3">
            ...
            <!-- New/Unread Orders -->
            <a href="<?php echo e(route('admin.orders.index', ['status' => 'pending', 'view_status' => 'unread'])); ?>" 
               class="inline-flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-colors
                      <?php echo e(request('status') === 'pending' && request('view_status') === 'unread' ? 'bg-red-500/20 text-red-400 border border-red-500/30' : 'bg-gray-700/50 text-gray-300 hover:bg-red-500/10 hover:text-red-400'); ?>">
                ...
                <?php if($newOrdersCount > 0): ?>
                    <span class="ml-2 px-2 py-1 bg-red-500 text-white text-xs rounded-full"><?php echo e($newOrdersCount); ?></span>
                <?php endif; ?>
            </a>
            ...
            <a href="<?php echo e(route('admin.orders.index', ['status' => 'confirmed'])); ?>" 
               class="inline-flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-colors
                      <?php echo e(request('status') === 'confirmed' ? 'bg-blue-500/20 text-blue-400 border border-blue-500/30' : 'bg-gray-700/50 text-gray-300 hover:bg-blue-500/10 hover:text-blue-400'); ?>">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php if($confirmedCount > 0): ?>
                    <span class="ml-2 px-2 py-1 bg-blue-500/70 text-white text-xs rounded-full"><?php echo e($confirmedCount); ?></span>
                <?php endif; ?>
            </a>
            ...
            <a href="<?php echo e(route('admin.orders.index', ['status' => 'pending'])); ?>" 
               class="inline-flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-colors
                      <?php echo e(request('status') === 'pending' && !request('view_status') ? 'bg-yellow-500/20 text-yellow-400 border border-yellow-500/30' : 'bg-gray-700/50 text-gray-300 hover:bg-yellow-500/10 hover:text-yellow-400'); ?>">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php if($pendingCount > 0): ?>
                    <span class="ml-2 px-2 py-1 bg-yellow-500/70 text-white text-xs rounded-full"><?php echo e($pendingCount); ?></span>
                <?php endif; ?>
            </a>
            ...
            <a href="<?php echo e(route('admin.orders.index', ['status' => 'processing'])); ?>" 
               class="inline-flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-colors
                      <?php echo e(request('status') === 'processing' ? 'bg-purple-500/20 text-purple-400 border border-purple-500/30' : 'bg-gray-700/50 text-gray-300 hover:bg-purple-500/10 hover:text-purple-400'); ?>">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php if($processingCount > 0): ?>
                    <span class="ml-2 px-2 py-1 bg-purple-500/70 text-white text-xs rounded-full"><?php echo e($processingCount); ?></span>
                <?php endif; ?>
            </a>
            ...
            <a href="<?php echo e(route('admin.orders.index', ['payment_status' => 'pending'])); ?>" 
               class="inline-flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-colors
                      <?php echo e(request('payment_status') === 'pending' ? 'bg-orange-500/20 text-orange-400 border border-orange-500/30' : 'bg-gray-700/50 text-gray-300 hover:bg-orange-500/10 hover:text-orange-400'); ?>">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php if($paymentPendingCount > 0): ?>
                    <span class="ml-2 px-2 py-1 bg-orange-500/70 text-white text-xs rounded-full"><?php echo e($paymentPendingCount); ?></span>
                <?php endif; ?>
            </a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select id="payment_method" name="payment_method" class="w-full px-3 py-2 bg-[#0f0f0f] border border-gray-700 rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#f59e0b]">
                            ...
                            <option value="webxpay" <?php echo e(request('payment_method') === 'webxpay' ? 'selected' : ''); ?>>💳 WebXPay</option>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select id="view_status" name="view_status" class="w-full px-3 py-2 bg-[#0f0f0f] border border-gray-700 rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#f59e0b]">
                            ...
                            <option value="unviewed" <?php echo e(request('view_status') === 'unviewed' ? 'selected' : ''); ?>>🔵 Unviewed Only</option>
                            <option value="viewed" <?php echo e(request('view_status') === 'viewed' ? 'selected' : ''); ?>>👁️ Viewed Only</option>
                        </select>
                    </div>
                    ...
                    <div class="flex items-end space-x-2">
                        ...
                        <?php if(request()->hasAny(['search', 'status', 'payment_status', 'payment_method', 'view_status', 'date_from', 'date_to'])): ?>
                            <a href="<?php echo e(route('admin.orders.index')); ?>" class="px-4 py-2 border border-gray-700 text-gray-300 rounded-lg hover:bg-gray-800 transition-colors text-sm flex items-center">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                                </svg>
                                Clear
                    ...
                    <div class="flex flex-wrap gap-2 pt-2 border-t border-gray-700">
                        ...
                        <?php if(request('search')): ?>
                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs bg-blue-900/50 text-blue-200 border border-blue-700">
                                ...
                                <a href="<?php echo e(route('admin.orders.index', request()->except('search'))); ?>" class="ml-1 text-blue-300 hover:text-blue-100">×</a>
                            </span>
                        <?php endif; ?>
                        ...
                        <?php if(request('status')): ?>
                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs bg-purple-900/50 text-purple-200 border border-purple-700">
                                ...
                                <a href="<?php echo e(route('admin.orders.index', request()->except('status'))); ?>" class="ml-1 text-purple-300 hover:text-purple-100">×</a>
                            </span>
                        <?php endif; ?>
                        ...
                        <?php if(request('payment_status')): ?>
                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs bg-green-900/50 text-green-200 border border-green-700">
                                Payment Status: <?php echo e(ucfirst(request('payment_status'))); ?>

                                <a href="<?php echo e(route('admin.orders.index', request()->except('payment_status'))); ?>" class="ml-1 text-green-300 hover:text-green-100">×</a>
                            </span>
                        <?php endif; ?>
                        ...
                        <?php if(request('payment_method')): ?>
                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs bg-indigo-900/50 text-indigo-200 border border-indigo-700">
                                Method: 
                                <?php if(request('payment_method') === 'webxpay'): ?>
                                    💳 WebXPay
                                <?php elseif(request('payment_method') === 'kokopay'): ?>
                                    ⏰ Koko Pay
                                <?php elseif(request('payment_method') === 'bank_transfer'): ?>
                                    🏦 Bank Transfer
                                <?php else: ?>
                                    <?php echo e(ucfirst(str_replace('_', ' ', request('payment_method')))); ?>

                                <?php endif; ?>
                                <a href="<?php echo e(route('admin.orders.index', request()->except('payment_method'))); ?>" class="ml-1 text-indigo-300 hover:text-indigo-100">×</a>
                            </span>
                        <?php endif; ?>

                        <?php if(request('view_status')): ?>
                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs bg-cyan-900/50 text-cyan-200 border border-cyan-700">
                                View: <?php echo e(request('view_status') === 'unviewed' ? '🔵 Unviewed' : '👁️ Viewed'); ?>

                                <a href="<?php echo e(route('admin.orders.index', request()->except('view_status'))); ?>" class="ml-1 text-cyan-300 hover:text-cyan-100">×</a>
                            </span>
                        <?php endif; ?>
                        ...
                        <?php if(request('date_from') || request('date_to')): ?>
                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs bg-orange-900/50 text-orange-200 border border-orange-700">
                                Date: 
                                <?php if(request('date_from') && request('date_to')): ?>
                                    <?php echo e(request('date_from')); ?> to <?php echo e(request('date_to')); ?>

                                <?php elseif(request('date_from')): ?>
                                    From <?php echo e(request('date_from')); ?>

                                <?php else: ?>
                                    Until <?php echo e(request('date_to')); ?>

                                <?php endif; ?>
                                <a href="<?php echo e(route('admin.orders.index', request()->except(['date_from', 'date_to']))); ?>" class="ml-1 text-orange-300 hover:text-orange-100">×</a>
                            </span>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-800">
                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-800/30 transition-colors <?php echo e(!$order->isViewedByAdmin() ? 'bg-blue-900/20 border-l-4 border-blue-500' : ''); ?>">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center space-x-3">
                                        <div>
                                            <div class="flex items-center space-x-2">
                                                <div class="text-sm font-medium <?php echo e(!$order->isViewedByAdmin() ? 'text-blue-200 font-bold' : 'text-white'); ?>">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center space-x-2">
                                        <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium <?php echo e($order->payment_method_badge); ?>">
                                        ...
                                        <?php elseif($order->payment_method === 'webxpay'): ?>
    ...
    if (dateTo) {
        dateTo.addEventListener('change', function() {
            if (this.value) {
                ...
                dateFrom.max = '<?php echo e(now()->format('Y-m-d')); ?>';
            }
            validateDateRange();
        });
    }
