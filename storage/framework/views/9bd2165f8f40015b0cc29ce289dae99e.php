...
<div class="space-y-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div class="flex flex-col sm:flex-row gap-3">
            <a href="<?php echo e(route('admin.activity-logs.export')); ?>" 
        ...
        <div class="bg-gradient-to-br from-blue-500/10 to-blue-600/5 border border-blue-500/20 rounded-xl p-4 lg:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl lg:text-3xl font-bold text-white"><?php echo e(number_format($stats['total_activities'] ?? 0)); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-br from-green-500/10 to-green-600/5 border border-green-500/20 rounded-xl p-4 lg:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl lg:text-3xl font-bold text-white"><?php echo e(number_format($stats['by_type']['customer'] ?? 0)); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-purple-500/20 rounded-xl p-4 lg:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl lg:text-3xl font-bold text-white"><?php echo e(number_format($stats['by_type']['system'] ?? 0)); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-br from-orange-500/10 to-orange-600/5 border border-orange-500/20 rounded-xl p-4 lg:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl lg:text-3xl font-bold text-white"><?php echo e(number_format($stats['by_type']['admin'] ?? 0)); ?></p>
                </div>
                    ...
                    <tr class="hover:bg-gray-700/30 transition-colors">
                        ...
                        <td class="px-4 lg:px-6 py-4">
                            <div class="flex flex-col">
                                ...
                                <div class="text-xs text-gray-400 mt-1 sm:hidden">
                                    <?php echo e($log->causer ? $log->causer->name : 'System'); ?> • 
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium
                                        <?php echo e($log->type == 'customer' ? 'bg-green-100 text-green-800' : 
                        ...
                        <td class="px-4 lg:px-6 py-4 hidden sm:table-cell">
                            ...
                            <div class="text-xs text-gray-400">
                                <?php echo e($log->causer ? $log->causer->email : 'Automated'); ?>
                        ...
                        <td class="px-4 lg:px-6 py-4 hidden md:table-cell">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                <?php echo e($log->type == 'customer' ? 'bg-green-500/20 text-green-400 border border-green-500/20' : 
                        ...
                        <td class="px-4 lg:px-6 py-4">
                            <div class="text-sm text-white">
                                <?php echo e($log->created_at->format('M j')); ?>
        ...
        <div class="px-4 lg:px-6 py-4 border-t border-gray-700">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class="text-sm text-gray-400">
                    Showing <?php echo e($activities->firstItem()); ?> to <?php echo e($activities->lastItem()); ?> of <?php echo e($activities->total()); ?> results
                </div>
                <div class="flex space-x-1">
                    <?php echo e($activities->appends(request()->query())->links('pagination::tailwind')); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\MSK\MSKMSV3\resources\views/admin/activity-logs/index.blade.php ENDPATH**/ ?>