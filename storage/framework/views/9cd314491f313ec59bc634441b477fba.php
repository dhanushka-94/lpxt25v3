...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-400 mb-1">Koko Pay Order ID</label>
                        <p class="text-white font-mono bg-purple-900/20 px-2 py-1 rounded"><?php echo e($transaction->gateway_reference); ?></p>
                    </div>
                    <?php endif; ?>
                    ...
                    <div>
                        ...
                        <?php $cardType = $transaction->card_type; ?>
                        <div class="flex flex-col space-y-2">
                            ...
                            <?php if($cardType['type'] !== 'unknown'): ?>
                                <div class="flex items-center space-x-2 ml-8 p-2 bg-gray-700/30 rounded-lg">
                                    <span class="text-lg"><?php echo e($cardType['icon']); ?></span>
                                    <div class="flex flex-col">
                                        <span class="text-sm <?php echo e($cardType['color']); ?> font-medium"><?php echo e($cardType['brand']); ?></span>
                                        <?php if(isset($cardType['gateway']) && $transaction->payment_method === 'webxpay'): ?>
                                            <span class="text-xs text-gray-400">Gateway: <?php echo e($cardType['gateway']); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            <?php endif; ?>
            ...
            <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
                ...
                <div class="mt-6 bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2 text-sm">
                                    ...
                                    <?php if($transaction->gateway_reference): ?>
                                        <div class="flex justify-between">
                                            ...
                                            <span class="text-blue-400 font-mono text-xs"><?php echo e($transaction->gateway_reference); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="space-y-4">
                            <!-- Customer Information -->
                            <div class="bg-gray-700/30 rounded-lg p-4">
                                <h5 class="text-sm font-medium text-gray-300 mb-3">👤 Customer Information</h5>
                                <div class="text-sm text-gray-300">
                                    <p class="font-medium text-white"><?php echo e($order->customer_name); ?></p>
                                    <p class="text-blue-400">📞 <?php echo e($order->customer_phone); ?></p>
                            ...
                            <div class="bg-gray-700/30 rounded-lg p-4">
                                <h5 class="text-sm font-medium text-gray-300 mb-3">📊 Status Information</h5>
                                <div class="space-y-3">
                                    <div class="flex items-center space-x-2">
                                    ...
                                    <div class="text-xs text-gray-400">
                                        <p>Order Placed: <?php echo e($order->created_at->format('M d, Y \a\t g:i A')); ?></p>
                                        <?php if($transaction->completed_at): ?>
                                            <p>Payment Completed: <?php echo e($transaction->completed_at->format('M d, Y \a\t g:i A')); ?></p>
                                        <?php endif; ?>
        ...
        <div class="space-y-8">
            ...
            <?php if($transaction->payment_method === 'kokopay' && $transaction->metadata): ?>
            <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
                <h3 class="text-lg font-semibold text-white mb-6 flex items-center">
                    <div class="w-6 h-6 bg-purple-500/20 rounded flex items-center justify-center mr-2">
                        <svg class="w-3 h-3 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- WebXPay Details -->
            <?php if($transaction->payment_method === 'webxpay' && $transaction->metadata): ?>
            <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
                <h3 class="text-lg font-semibold text-white mb-6 flex items-center">
                    <div class="w-6 h-6 bg-purple-500/20 rounded flex items-center justify-center mr-2">
                        <svg class="w-3 h-3 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center p-3 bg-purple-900/20 rounded-lg border border-purple-500/30">
                        ...
                        <span class="text-white font-mono font-bold"><?php echo e($transaction->gateway_reference); ?></span>
                    </div>
                    <?php endif; ?>
                    
                    <?php if(isset($transaction->metadata['payment_gateway'])): ?>
                    <div class="flex justify-between items-center p-3 bg-purple-900/20 rounded-lg border border-purple-500/30">
                        <span class="text-purple-300 font-medium">Payment Gateway</span>
                        <span class="text-white capitalize"><?php echo e($transaction->metadata['payment_gateway']); ?></span>
                    </div>
                    <?php endif; ?>
                    
                    <?php if(isset($transaction->metadata['transaction_datetime'])): ?>
                    <div class="flex justify-between items-center p-3 bg-purple-900/20 rounded-lg border border-purple-500/30">
                        <span class="text-purple-300 font-medium">Transaction DateTime</span>
                        <span class="text-white font-mono"><?php echo e($transaction->metadata['transaction_datetime']); ?></span>
                    </div>
                    <?php endif; ?>
                    
                    <?php if(isset($transaction->metadata['signature_valid'])): ?>
                    <div class="flex justify-between items-center p-3 bg-purple-900/20 rounded-lg border border-purple-500/30">
                        <span class="text-purple-300 font-medium">Signature Valid</span>
                        <span class="text-white font-bold <?php echo e($transaction->metadata['signature_valid'] ? 'text-green-400' : 'text-red-400'); ?>">
                            <?php echo e($transaction->metadata['signature_valid'] ? 'YES' : 'NO'); ?>
                    ...
                    <div class="p-3 bg-purple-900/20 rounded-lg border border-purple-500/30">
                        ...
                        <div class="space-y-2 text-sm">
                            <?php if(isset($transaction->gateway_response['order_id'])): ?>
                            <div class="flex justify-between">
                                <span class="text-gray-400">Order ID:</span>
                                <span class="text-white font-mono"><?php echo e($transaction->gateway_response['order_id']); ?></span>
                            </div>
                            <?php endif; ?>
                            <?php if(isset($transaction->gateway_response['status_code'])): ?>
                            <div class="flex justify-between">
                                <span class="text-gray-400">Status Code:</span>
                                <span class="text-white font-mono"><?php echo e($transaction->gateway_response['status_code']); ?></span>
                            </div>
                            <?php endif; ?>
                            <?php if(isset($transaction->gateway_response['comment'])): ?>
                            <div class="flex justify-between">
                                <span class="text-gray-400">Comment:</span>
                                <span class="text-white"><?php echo e($transaction->gateway_response['comment'] ?: '(empty)'); ?></span>
                            </div>
                            <?php endif; ?>
                            <?php if(isset($transaction->gateway_response['payment_status'])): ?>
                            <div class="flex justify-between">
                                <span class="text-gray-400">Payment Status:</span>
                                <span class="text-white font-bold <?php echo e($transaction->gateway_response['payment_status'] === 'success' ? 'text-green-400' : 'text-red-400'); ?>">
                                    <?php echo e(strtoupper($transaction->gateway_response['payment_status'])); ?>
                    ...
                    <!-- CUSTOM FIELDS -->
                    <?php if(isset($transaction->metadata['custom_fields']) && $transaction->metadata['custom_fields']): ?>
                    <div class="p-3 bg-purple-900/20 rounded-lg border border-purple-500/30">
                        <div class="text-purple-300 font-medium mb-2">Custom Fields</div>
                        <div class="text-white font-mono text-xs break-all bg-purple-800/30 p-2 rounded">
                            <?php echo e($transaction->metadata['custom_fields']); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\MSK\MSKMSV3\resources\views/admin/transactions/show.blade.php ENDPATH**/ ?>