...
<section class="relative bg-[#0f0f0f] border-b border-gray-800/30 py-4 md:py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <?php if(str_contains(strtolower($category->name), 'laptop')): ?>
                            ...
                            <div class="bg-[#2c2c2e] rounded-lg p-3 mb-4 border border-gray-700/50">
                                <div class="flex items-center justify-between">
                                    <div class="text-center flex-1">
                                        ...
                                        <div class="text-sm font-medium text-white">Rs. <span id="min-price-display"><?php echo e(number_format($priceRange['min'] ?? 0)); ?></span></div>
                                    </div>
                                    <div class="w-px h-8 bg-gray-600 mx-3"></div>
                                    <div class="text-center flex-1">
                                        <div class="text-xs text-gray-500 mb-1">To</div>
                                        <div class="text-sm font-medium text-white">Rs. <span id="max-price-display"><?php echo e(number_format($priceRange['max'] ?? 100000)); ?></span></div>
                                    </div>
                                </div>
                            </div>
