        ...
        <div class="space-y-6">
            ...
            <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
                ...
                <div class="space-y-2 text-sm">
                    ...
                    <div>
                        <span class="text-gray-400">Payment Method:</span>
                        <span class="text-white ml-2"><?php echo e($order->payment_method_display ?? ucfirst(str_replace('_', ' ', $order->payment_method))); ?></span>
                    </div>
                    <?php if($order->payment_reference): ?>
                        <div>
                            <span class="text-gray-400">Transaction ID:</span>
                            <span class="text-white ml-2 font-mono text-sm"><?php echo e($order->payment_reference); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        <span class="text-gray-400">Payment Method</span>
                        <span class="inline-flex items-center px-3 py-1 rounded-lg text-sm font-medium <?php echo e($order->payment_method_badge); ?>">
                            <?php echo e($order->payment_method_display ?? ucfirst(str_replace('_', ' ', $order->payment_method))); ?>
                    ...
                    <?php elseif($order->payment_method === 'webxpay'): ?>
                        ...
                        <?php if($webxpayReference): ?>
                        <div class="flex items-center justify-between">
                            <span class="text-gray-400">💳 WebXPay Reference</span>
                            <div class="flex items-center space-x-2">
                                <span class="bg-purple-900/30 px-3 py-1 rounded-lg text-purple-300 font-mono text-sm font-bold border border-purple-500/30">
                                    <?php echo e($webxpayReference); ?>

                                </span>
                                <?php if($webxpayTransaction): ?>
                                <a href="<?php echo e(route('admin.transactions.show', $webxpayTransaction)); ?>" 
                                   class="text-purple-400 hover:text-purple-300 text-xs">
                                    View Transaction →
                                </a>
                                <?php endif; ?>
                                    ...
                                    <div class="flex-shrink-0">
                                        ...
                                        <?php if($isImage): ?>
                                            ...
                                            <div class="w-32 h-32 bg-gray-900 rounded-lg overflow-hidden border border-gray-600">
                                                <img src="<?php echo e(asset('storage/' . $order->transfer_slip_path)); ?>" 
                                                     alt="Transfer Slip" 
                                                     class="w-full h-full object-cover cursor-pointer hover:opacity-90 transition-opacity"
                                                     onclick="openImageModal('<?php echo e(asset('storage/' . $order->transfer_slip_path)); ?>', 'Transfer Slip - <?php echo e($order->order_number); ?>')">
                                            </div>
                                        <?php elseif($isPdf): ?>
                                            <!-- PDF Icon -->
                                        ...
                                        <?php else: ?>
                                            ...
                                            <div class="w-32 h-32 bg-gray-900 rounded-lg border border-gray-600 flex items-center justify-center">
                                                <div class="text-center">
                                                    ...
                                                    <span class="text-xs text-gray-400 font-medium"><?php echo e(strtoupper($fileExtension)); ?></span>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="space-y-2">
                                            <div>
                                                ...
                                                <div class="text-xs text-gray-400"><?php echo e(basename($order->transfer_slip_path)); ?></div>
                                            </div>
                                            
                                            <div class="text-xs text-gray-500">
                                                <div>File Type: <?php echo e(strtoupper($fileExtension)); ?></div>
                                                <?php if(Storage::disk('public')->exists($order->transfer_slip_path)): ?>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <div>Size: <?php echo e($formattedSize); ?></div>
                                                <?php endif; ?>
                                                <div>Uploaded: <?php echo e($order->created_at->format('M d, Y \a\t g:i A')); ?></div>
                                            </div>
                                            
                                            <!-- Action Buttons -->
                                            <div class="flex items-center space-x-2 pt-2">
                                                <a href="<?php echo e(asset('storage/' . $order->transfer_slip_path)); ?>" 
                                                   target="_blank"
                                                ...
                                                ?>
                                                <a href="<?php echo e(asset('storage/' . $order->transfer_slip_path)); ?>" 
                                                   download="transfer_slip_<?php echo e($order->order_number); ?>_<?php echo e($cleanCustomerName); ?>_<?php echo e($cleanCustomerPhone); ?>.<?php echo e($fileExtension); ?>"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[#f59e0b] font-bold">LKR <?php echo e(number_format($order->total_amount, 2)); ?></span>
                    </div>
                </div>
            </div>
