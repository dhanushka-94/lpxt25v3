<?php $__env->startSection('title', 'MSK COMPUTERS - Your Trusted Computer Store in Sri Lanka'); ?>
<?php $__env->startSection('description', 'MSK Computers - Your trusted partner for computer hardware, gaming PCs, laptops, and technology solutions in Sri Lanka. Quality products, competitive prices, and expert service.'); ?>
<?php $__env->startSection('keywords', 'MSK Computers, computer store Sri Lanka, gaming PC, laptops, computer hardware, graphics cards, processors, motherboards, technology solutions'); ?>
<?php $__env->startSection('og_title', 'MSK COMPUTERS - Your Trusted Computer Store in Sri Lanka'); ?>
<?php $__env->startSection('og_description', 'Discover premium computer hardware, gaming PCs, and technology solutions at MSK Computers. Quality products with warranty and expert service in Sri Lanka.'); ?>
        ...
        <div class="hero-slide active relative h-[500px] md:h-[600px] lg:h-[700px] flex items-center">
            ...
            <div class="absolute inset-0">
                <video 
                    ...
                    id="heroVideo">
                    <source src="<?php echo e(asset('videos/slider/mskcomputers-video-promo.webm')); ?>" type="video/webm">
...
<section class="py-12 md:py-16 bg-gradient-to-b from-black to-[#0f0f0f] relative">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="group bg-[#1a1a1c] rounded-xl border border-gray-800/30 overflow-hidden hover:border-[#f59e0b]/30 transition-all duration-300 shadow-lg hover:shadow-xl">
                        <div class="relative overflow-hidden">
                            ...
                            <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center">
                                <div class="transform translate-y-8 group-hover:translate-y-0 transition-all duration-500 space-y-3">
                                    ...
                                    <?php if($product->stock_quantity > 0): ?>
                                        <button onclick="addToCartFromHome(<?php echo e($product->id); ?>, '<?php echo e(addslashes($product->name)); ?>')" 
                        ...
                        <div class="p-6">
                            ...
                            <h3 class="text-lg font-semibold text-white mb-3 leading-tight">
                                <a href="<?php echo e(route('products.show', ['category' => $product->category->slug ?: $product->category->id, 'product' => $product->slug])); ?>" class="hover:text-[#f59e0b] transition-colors">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex flex-col">
                                    <?php if($product->is_on_sale): ?>
                                        ...
                                        <span class="text-xl font-bold text-[#f59e0b]">LKR <?php echo e(number_format($product->promo_price, 2)); ?></span>
                                    <?php else: ?>
                                        <?php if($product->price > 0): ?>
                                            <span class="text-xl font-bold text-white">LKR <?php echo e(number_format($product->price, 2)); ?></span>
                                        <?php else: ?>
        ...
        <div class="text-center mt-12">
            <a href="<?php echo e(route('products.index')); ?>" class="btn-outline text-lg px-8 py-4">View All Products</a>
        </div>
    </div>
</section>
                ...
                <div class="flex animate-scroll-right">
                    ...
                    <div class="flex space-x-6 min-w-full">
                        ...
                        <div class="customer-photo-card flex-shrink-0 w-48 h-48 rounded-2xl overflow-hidden border-2 border-gray-800 hover:border-[#f59e0b] transition-all duration-300 group">
                            <img src="<?php echo e(asset('images/happy-customers/hc00 (1).jpg')); ?>" 
                        ...
                        <!-- Happy Customer 2 -->
                        <div class="customer-photo-card flex-shrink-0 w-48 h-48 rounded-2xl overflow-hidden border-2 border-gray-800 hover:border-[#f59e0b] transition-all duration-300 group">
                            <img src="<?php echo e(asset('images/happy-customers/hc00 (2).jpg')); ?>" 
                                 alt="Happy MSK Customer" 
                                 class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        </div>
                        ...
                        <!-- Happy Customer 3 -->
                        <div class="customer-photo-card flex-shrink-0 w-48 h-48 rounded-2xl overflow-hidden border-2 border-gray-800 hover:border-[#f59e0b] transition-all duration-300 group">
                            <img src="<?php echo e(asset('images/happy-customers/hc00 (3).jpg')); ?>" 
                                 alt="Happy MSK Customer" 
                                 class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        </div>
                        ...
                        <!-- Happy Customer 4 -->
                        <div class="customer-photo-card flex-shrink-0 w-48 h-48 rounded-2xl overflow-hidden border-2 border-gray-800 hover:border-[#f59e0b] transition-all duration-300 group">
                            <img src="<?php echo e(asset('images/happy-customers/hc00 (4).jpg')); ?>" 
                                 alt="Happy MSK Customer" 
                                 class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        </div>
                        ...
                        <!-- Happy Customer 5 -->
                        <div class="customer-photo-card flex-shrink-0 w-48 h-48 rounded-2xl overflow-hidden border-2 border-gray-800 hover:border-[#f59e0b] transition-all duration-300 group">
                            <img src="<?php echo e(asset('images/happy-customers/hc00 (5).jpg')); ?>" 
                                 alt="Happy MSK Customer" 
                                 class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        </div>
                        ...
                        <!-- Happy Customer 6 -->
                        <div class="customer-photo-card flex-shrink-0 w-48 h-48 rounded-2xl overflow-hidden border-2 border-gray-800 hover:border-[#f59e0b] transition-all duration-300 group">
                            <img src="<?php echo e(asset('images/happy-customers/hc00 (6).jpg')); ?>" 
                                 alt="Happy MSK Customer" 
                                 class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        </div>
                    </div>
            ...
            <div class="customer-slider-container" id="customerSlider2">
                <div class="flex animate-scroll-left">
                    ...
                    <div class="flex space-x-6 min-w-full">
                        <!-- Happy Customer 7 -->
                        <div class="customer-photo-card flex-shrink-0 w-48 h-48 rounded-2xl overflow-hidden border-2 border-gray-800 hover:border-[#f59e0b] transition-all duration-300 group">
                            <img src="<?php echo e(asset('images/happy-customers/hc00 (7).jpg')); ?>" 
                                 alt="Happy MSK Customer" 
                                 class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        </div>
                        ...
                        <!-- Happy Customer 8 -->
                        <div class="customer-photo-card flex-shrink-0 w-48 h-48 rounded-2xl overflow-hidden border-2 border-gray-800 hover:border-[#f59e0b] transition-all duration-300 group">
                            <img src="<?php echo e(asset('images/happy-customers/hc00 (8).jpg')); ?>" 
                                 alt="Happy MSK Customer" 
                                 class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        </div>
                        ...
                        <!-- Happy Customer 9 -->
                        <div class="customer-photo-card flex-shrink-0 w-48 h-48 rounded-2xl overflow-hidden border-2 border-gray-800 hover:border-[#f59e0b] transition-all duration-300 group">
                            <img src="<?php echo e(asset('images/happy-customers/hc00 (9).jpg')); ?>" 
                                 alt="Happy MSK Customer" 
                                 class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        </div>
                        ...
                        <!-- Happy Customer 10 -->
                        <div class="customer-photo-card flex-shrink-0 w-48 h-48 rounded-2xl overflow-hidden border-2 border-gray-800 hover:border-[#f59e0b] transition-all duration-300 group">
                            <img src="<?php echo e(asset('images/happy-customers/hc00 (10).jpg')); ?>" 
                                 alt="Happy MSK Customer" 
                                 class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        </div>
                        ...
                        <!-- Happy Customer 11 -->
                        <div class="customer-photo-card flex-shrink-0 w-48 h-48 rounded-2xl overflow-hidden border-2 border-gray-800 hover:border-[#f59e0b] transition-all duration-300 group">
                            <img src="<?php echo e(asset('images/happy-customers/hc00 (11).jpg')); ?>" 
                                 alt="Happy MSK Customer" 
                                 class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        </div>
                        ...
                        <!-- Happy Customer 12 -->
                        <div class="customer-photo-card flex-shrink-0 w-48 h-48 rounded-2xl overflow-hidden border-2 border-gray-800 hover:border-[#f59e0b] transition-all duration-300 group">
                            <img src="<?php echo e(asset('images/happy-customers/hc00 (12).jpg')); ?>" 
                                 alt="Happy MSK Customer" 
                                 class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\MSK\MSKMSV3\resources\views/home.blade.php ENDPATH**/ ?>